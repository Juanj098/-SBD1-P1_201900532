...
--19.ORDER_PAYMENT--(pagos)
CREATE TABLE ORDER_PAYMENT(
    ID INTEGER CONSTRAINT order_payment_id_pk PRIMARY KEY ,
    ID_CUSTOMER INTEGER CONSTRAINT order_payment_id_customer_fk REFERENCES CUSTOMERS(ID) ON DELETE CASCADE,
    PAYMENT_METHOD VARCHAR(128) CONSTRAINT order_payment_method_nn NOT NULL,
    CREATED_AT TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO CUSTOMERS (id,dpi, name, lastname, email, password, phone, status, confirmed_email)
VALUES (1001,1234567890123, 'Test', 'User', 'test@example.com', 'password', '1234567890', 'true', 'TRUE');

DELETE FROM CUSTOMERS WHERE id = 1001;
DELETE FROM CUSTOMERS WHERE id = 1004;
DELETE FROM PAYMENTS WHERE id = 50001;